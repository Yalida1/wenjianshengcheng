...
const BLOCKS: Record<string, ContentBlock[]> = {
  s1: [
    { id: "b1-1", type: "heading", level: 1, content: "第一章 招标公告" },
    {
      ...
      type: "fixed_template",
      content:
        "某省通信有限公司（以下简称「招标人」）委托依法开展政府采购，现就中心机房节能改造项目所需货物及配套安装服务进行公开招标，欢迎符合资格条件的供应商参与投标。",
    },
    { id: "b1-3", type: "subheading", level: 2, content: "一、项目基本信息" },
    {
      ...
      content: "项目名称：某省公司中心机房节能改造项目",
    },
    {
      id: "b1-5",
      type: "confirmed_field",
      fieldKey: "procurement_type",
      content: "采购类型：货物类（含安装）",
    },
    {
      id: "b1-6",
      type: "confirmed_field",
    ...
    },
    {
      id: "b1-7",
      type: "confirmed_field",
      fieldKey: "tender_budget",
      content: "招标预算：人民币玖佰捌拾万元整（¥9,800,000.00）",
      hasIssue: true,
    },
    { id: "b1-8", type: "subheading", level: 2, content: "二、投标人资格要求" },
    {
      ...
      type: "fixed_template",
      content:
        "投标人须具备有效的营业执照、相应等级的资质证书，以及近三年类似项目业绩证明材料。具体要求详见第二章投标人须知。",
    },
  ...
  s2: [
    { id: "b2-1", type: "heading", level: 1, content: "第二章 投标人须知" },
    {
      id: "b2-2",
      type: "fixed_template",
      content: "本章所有条款均为本次招标的法定须知，投标人须完整阅读并遵守。",
    },
    { id: "b2-3", type: "subheading", level: 2, content: "2.1 定义" },
    {
      ...
      type: "fixed_template",
      content:
        '"招标人"指某省通信有限公司；"投标人"指参加本次招标的法人或其他组织；"中标人"指经依法评审程序确定的供应商。',
    },
    {
      id: "b2-5",
      type: "subheading",
      level: 2,
      content: "2.2 招标文件及投标文件",
    },
    {
      id: "b2-6",
      type: "confirmed_field",
      fieldKey: "tender_number",
      content: "招标编号：{{ tender_number }}",
      placeholder: true,
      hasIssue: true,
    },
    {
      ...
      aiReviewed: false,
      content:
        "投标截止时间及开标时间以招标代理机构正式发布的公告为准。投标文件须密封提交，逾期提交的投标文件不予接受。",
    },
    { id: "b2-8", type: "subheading", level: 2, content: "2.3 评标原则" },
    {
      id: "b2-9",
      type: "fixed_template",
      content: "本次招标采用综合评分法，评分细则详见评标办法章节。",
    },
  ],
  s3: [
    ...
    { id: "b3-4", type: "subheading", level: 2, content: "3.2 项目背景" },
    {
      ...
      aiReviewed: true,
      content:
        "根据现有机房运行情况及节能改造需求，某省通信有限公司现有中心机房综合能效指标（PUE）偏高，设备老化情况明显。为降低运营成本、提升机房整体能效，本项目拟对中心机房相关设备和配套环境进行系统性更新改造，以达到绿色数据中心标准。",
    },
    { id: "b3-6", type: "subheading", level: 2, content: "3.3 本次采购范围" },
    {
      ...
      content:
        "本次采购包括 UPS 主机、蓄电池组、精密空调、动环监控系统及相关安装调试服务。具体清单详见第四章及附件。",
    },
    { id: "b3-8", type: "subheading", level: 2, content: "3.4 建设目标" },
    {
      ...
      editedAt: "14:22",
      content:
        "完成改造后，机房 PUE 值应不高于 1.5，核心供电设备运行可靠性不低于 99.99%，监控系统覆盖率达到 100%。",
    },
  ],
  s4: [
    {
    ...
    { id: "b4-2", type: "subheading", level: 2, content: "4.1 设备清单" },
    {
      ...
      aiReviewed: false,
      content:
        "采购设备清单包括但不限于：UPS 主机（模块化）2 套，蓄电池组 4 组，精密空调 6 台，动环监控主机 1 套，相关辅材及安装服务 1 批。",
      hasIssue: true,
    },
    ...
    { id: "b4-6", type: "subheading", level: 2, content: "4.3 安装调试要求" },
    {
      ...
      type: "ai_generated",
      aiReviewed: false,
      content: "供应商须在交付期内完成设备安装、调试、功能测试及人员培训，并提交完整的竣工文档。",
    },
    {
      id: "b4-8",
      type: "subheading",
      level: 2,
      content: "4.4 交付地点与交付期",
    },
    {
      id: "b4-9",
      type: "confirmed_field",
      fieldKey: "delivery_location",
      content: "交付地点：某省通信有限公司中心机房（具体地址以合同为准）",
    },
    {
      id: "b4-10",
      type: "confirmed_field",
      fieldKey: "delivery_period",
      content: "交付周期：合同签订后 90 日内完成安装调试",
    },
  ],
  s5: [
    { id: "b5-1", type: "heading", level: 1, content: "第五章 商务要求" },
    {
      ...
      type: "subheading",
      level: 2,
      content: "5.1 招标预算及最高限价",
    },
    {
      id: "b5-3",
      type: "confirmed_field",
      fieldKey: "tender_budget",
      content: "本次招标预算为人民币壹仟贰佰捌拾万元整（¥12,800,000.00）",
      hasIssue: true,
    },
    {
      id: "b5-4",
      type: "ai_generated",
      aiReviewed: false,
      content: "投标人报价不得超过最高限价，超出限价的投标文件将被作为无效投标处理。",
    },
    { id: "b5-5", type: "subheading", level: 2, content: "5.2 付款方式" },
    {
      ...
      editedAt: "14:35",
      content:
        "付款方式：合同签订后预付 30%，设备到货验收后支付 50%，竣工验收后支付剩余 20%。质保期内无息留存金 5%。",
    },
    { id: "b5-7", type: "subheading", level: 2, content: "5.3 质保要求" },
    {
      ...
      content: "质保期：不少于 3 年，自竣工验收合格之日起计算",
    },
  ],
  s6: [
    { id: "b6-1", type: "heading", level: 1, content: "第六章 合同条款及格式" },
    {
      ...
      type: "fixed_template",
      content:
        "本章合同条款依据《政府采购法》及相关法规制定，为正式合同模板内容，不得随意修改。买卖双方须严格遵守本章所有条款。",
    },
    {
      id: "b6-3",
      type: "fixed_template",
      content:
        "合同主要条款包括：合同标的与数量、合同价格及支付方式、交货期及交货方式、验收条件、违约责任、争议解决方式等。详细格式见附件。",
    },
  ],
  s7: [
    { id: "b7-1", type: "heading", level: 1, content: "第七章 投标文件格式" },
    {
      ...
      type: "fixed_template",
      content:
        "投标文件须按照本章规定的格式和顺序编制，缺少任何必要格式或顺序混乱将影响投标有效性。",
    },
    { id: "b7-3", type: "subheading", level: 2, content: "7.1 投标文件目录" },
    {
      ...
      type: "fixed_template",
      content:
        "投标文件应包括：封面及目录、法定代表人授权书、投标函、商务响应文件、技术响应文件、资质证明文件、业绩证明材料、报价文件。",
    },
  ],
  s8: [
...
const INITIAL_ISSUES: ValidationIssue[] = [
  {
    ...
    sectionName: "商务要求",
    description:
      "招标公告（第1章）：¥9,800,000；商务要求（第5章）：¥12,800,000。金额不一致，可能导致投标无效或法律纠纷。",
    resolved: false,
    suggestion: "使用已确认字段值 ¥9,800,000 统一全文",
  },
  {
    id: "v2",
    severity: "P0",
    title: "发现未替换占位符 {{ tender_number }}",
    sectionId: "s2",
    sectionName: "投标人须知",
    description: "投标人须知第2.2节存在未替换的模板变量 {{ tender_number }}。",
    resolved: false,
    suggestion: "在字段确认中补充招标编号字段",
  },
  {
    id: "v3",
    severity: "P1",
    title: "采购需求章节包含 3 段未人工审阅的 AI 草稿",
    sectionId: "s4",
    sectionName: "采购需求及技术要求",
    description: "第四章3处AI生成段落尚未经人工审阅，在定稿前需确认内容准确性。",
    resolved: false,
    suggestion: "逐段审阅并标记已确认",
  },
  {
    id: "v4",
    severity: "P1",
    title: "商务要求中交付周期与第四章表述不一致",
    sectionId: "s5",
    sectionName: "商务要求",
    description: "第四章：合同签订后90日；商务要求第5.1节：未明确。请确认二者一致。",
    resolved: false,
    suggestion: "在商务要求中补充交付周期表述",
  },
  {
    id: "v5",
    severity: "P2",
    ...
    sectionId: "s3",
    sectionName: "项目概况",
    description: "第3.2节与第3.4节中均出现「提升机房整体能效」相关表述，建议精简。",
    resolved: false,
    suggestion: "使用 AI 辅助精简重复段落",
  },
  {
    id: "v6",
    severity: "P2",
    title: "第七章投标文件格式未包含电子版提交说明",
    sectionId: "s7",
    sectionName: "投标文件格式",
    description: "模板要求包含电子文件提交说明，当前版本未见相关内容。",
    resolved: false,
    suggestion: "补充电子文件提交格式说明",
  },
];
...
function SeverityBadge({ s }: { s: "P0" | "P1" | "P2" }) {
  const cls = {
    P0: "bg-[#FEF1F2] text-[#A8323C]",
    P1: "bg-[#FFF7E6] text-[#8B520B]",
    P2: "bg-slate-100 text-slate-500",
  };
  return (
    <span
      className={`inline-flex items-center rounded px-1.5 py-0.5 text-[10px] font-bold ${cls[s]}`}
    >
      {s}
    </span>
  );
  ...
  return (
    <div className="flex h-14 shrink-0 items-center gap-3 border-b border-slate-200 bg-white px-4 xl:px-6">
      ...
      >
        ...
        <span className="hidden xl:block">项目详情</span>
      </button>
      ...
      <div className="flex min-w-0 items-center gap-3 flex-1">
        <div className="min-w-0">
          <div className="flex items-center gap-2">
            ...
            {docStatus === "finalized" ? (
              <span className="shrink-0 rounded-full bg-[#ECF8F2] px-2 py-0.5 text-[11px] font-medium text-[#116B46]">
                已定稿
              </span>
            ) : (
      ...
      <div className="flex shrink-0 items-center gap-1">
        ...
        <button
          ...
          className={`h-7 w-7 rounded flex items-center justify-center text-slate-500 hover:bg-slate-100 ${
            showMarkers ? "bg-[#F2F6FC] text-[#2E5495]" : ""
          }`}
        >
          <Icon name="eye" size={14} />
        </button>
        <button
          onClick={onShowVersionMenu}
          title="版本对比"
          className="h-7 w-7 rounded flex items-center justify-center text-slate-500 hover:bg-slate-100"
        >
        ...
        <button
          ...
          title="校验问题"
          className={`relative h-7 rounded px-2 flex items-center gap-1 text-xs text-slate-500 hover:bg-slate-100 ${
            p0Count > 0 ? "text-[#A8323C]" : ""
          }`}
        >
          <Icon name="shield" size={14} />
          {p0Count > 0 && (
            <span className="absolute -right-1 -top-1 flex h-4 w-4 items-center justify-center rounded-full bg-[#A8323C] text-[9px] font-bold text-white">
              {p0Count}
            </span>
          )}
        </button>
...
function DocumentOutline({
  ...
  const reviewedCount = sections.filter(
    (s) => s.reviewStatus === "reviewed" || s.reviewStatus === "passed",
  ).length;
      ...
      <aside className="flex w-[52px] shrink-0 flex-col border-r border-slate-200 bg-white">
        <div className="flex h-10 items-center justify-center border-b border-slate-100">
          <button
            ...
            title="展开目录"
            className="text-slate-400 hover:text-[#24457C]"
          >
    ...
    <aside className="flex w-[250px] shrink-0 flex-col border-r border-slate-200 bg-white overflow-hidden">
            ...
            <div className="min-w-0 flex-1">
              <p
                className={`text-[13px] leading-snug ${
                  selectedId === s.id ? "text-[#24457C] font-medium" : "text-slate-700"
                }`}
              >
                {s.number}. {s.title}
              </p>
              {s.issueCount > 0 && (
                <p className="text-[11px] text-[#A8323C] mt-0.5">{s.issueCount} 个问题</p>
              )}
            </div>
          </button>
        ))}
      ...
      <div className="border-t border-slate-100 px-3 py-3">
        <div className="flex justify-between text-[12px]">
          ...
          <span className="font-medium text-[#116B46]">
...
function ContentBlockView({
  ...
  if (block.type === "heading")
    return (
      <h2
        id={`block-${block.id}`}
        className="mt-8 mb-4 text-lg font-bold text-slate-900 border-b border-slate-200 pb-2"
      >
        {block.content}
      </h2>
    );
  if (block.type === "subheading")
    return (
      <h3 id={`block-${block.id}`} className="mt-5 mb-2 text-[15px] font-semibold text-slate-800">
        {block.content}
      </h3>
    );
  ...
  return (
    <div
      id={`block-${block.id}`}
      className={`relative group mb-3 rounded-sm ${
        block.hasIssue ? "ring-1 ring-[#FECDD0] ring-offset-1" : ""
      }`}
    >
      ...
      {showMarkers && (
        <div className="absolute -left-7 top-1 flex flex-col items-center gap-1">
          {block.type === "fixed_template" && (
            <span title="模板固定内容" className="text-slate-300 hover:text-slate-500">
              <Icon name="lock" size={12} />
            </span>
          )}
          {block.type === "ai_generated" && !block.aiReviewed && (
            <span title="AI 草稿，待审阅" className="text-[#8B520B]">
              <Icon name="zap" size={11} />
            </span>
          )}
          {block.type === "ai_generated" && block.aiReviewed && (
            <span title="AI 内容，已确认" className="text-[#116B46]">
              <Icon name="check-circle" size={11} />
            </span>
          )}
          {block.type === "user_edited" && (
            <span title={`${block.editedBy} 编辑于 ${block.editedAt}`} className="text-[#2E5495]">
        ...
        <div className="relative">
          <p
            className={`text-[14px] leading-7 text-slate-700 whitespace-pre-line ${
              !finalized ? "cursor-pointer hover:bg-slate-50 rounded px-1 py-0.5" : ""
            }`}
          ...
          {showFixedMenu && !finalized && (
            <div
              ref={menuRef}
              className="absolute left-0 top-full z-10 w-64 rounded-lg border border-slate-200 bg-white p-3 shadow-lg"
            >
              ...
              <div className="flex gap-2">
                <button className="flex-1 h-7 rounded border border-slate-300 text-xs text-slate-600 hover:border-[#2E5495]">
                  查看模板原文
                </button>
                <button className="flex-1 h-7 rounded border border-slate-300 text-xs text-slate-600 hover:border-[#2E5495]">
                  申请解锁
                ...
                <button
                  onClick={() => setShowFixedMenu(false)}
                  className="h-7 w-7 flex items-center justify-center rounded border border-slate-300 text-slate-400 hover:bg-slate-100"
                >
      ...
      {block.type === "confirmed_field" && (
        <div ref={menuRef} className="relative">
          <p
            className={`text-[14px] leading-7 whitespace-pre-line cursor-pointer rounded px-1 py-0.5 ${
              isPlaceholder
                ? "font-mono text-[#A8323C] bg-[#FEF1F2]"
                : "text-slate-800 font-medium hover:bg-[#F2F6FC]"
            } ${
              showMarkers && !isPlaceholder
                ? "underline decoration-dotted decoration-[#2E5495] underline-offset-2"
                : ""
            }`}
          ...
          {showFieldMenu && (
            <div className="absolute left-0 top-full z-10 w-56 rounded-lg border border-slate-200 bg-white py-1 shadow-lg">
              <button
                ...
                onClick={() => {
                  setShowFieldMenu(false);
                  if (block.fieldKey) onFieldClick(block.fieldKey);
                }}
              >
                查看字段详情 / 来源
              </button>
              ...
              {!finalized && (
                <button
                  className="w-full px-3 py-2 text-left text-sm text-[#A8323C] hover:bg-[#FEF1F2]"
                  onClick={() => setShowFieldMenu(false)}
                >
                  申请修改字段值
                </button>
              ...
              <button
                className="w-full px-3 py-2 text-left text-xs text-slate-400 hover:bg-slate-50 border-t border-slate-100 mt-1"
                onClick={() => setShowFieldMenu(false)}
              >
                关闭
              </button>
      ...
      {(block.type === "ai_generated" || block.type === "user_edited") && (
        <div className="relative">
          <p
            className={`text-[14px] leading-7 text-slate-700 whitespace-pre-line rounded px-1 py-0.5 ${
              !finalized ? "hover:bg-slate-50" : ""
            }`}
          >
            {block.content}
          </p>
          {!finalized && (
            <div className="absolute right-0 top-0 hidden items-center gap-1 group-hover:flex">
              {block.type === "ai_generated" && (
                <button
                  onClick={() => onParagraphSourceClick(block.id)}
                  title="查看来源"
                  className="h-6 rounded border border-slate-200 bg-white px-1.5 text-[11px] text-slate-500 hover:border-[#2E5495] shadow-sm"
                >
                  <Icon name="eye" size={11} />
                </button>
              )}
              <button
                onClick={() => onAIEditRequest(block.id)}
                title="AI 辅助修改"
                className="h-6 rounded border border-slate-200 bg-white px-1.5 text-[11px] text-[#2E5495] hover:bg-[#F2F6FC] shadow-sm"
              >
                <Icon name="zap" size={11} />
              </button>
            </div>
          ...
          {block.type === "user_edited" && showMarkers && (
            <p className="mt-0.5 text-[11px] text-[#2E5495]">
              {block.editedBy} 编辑于 {block.editedAt}
            </p>
          )}
        </div>
      )}
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div className="mb-4">
          ...
          <p className="font-mono text-xs text-slate-600">
            {isBudget ? "procurement.tender_budget" : "project.name"}
          </p>
        </div>
        <div className="mb-4">
          <p className="text-xs text-slate-500 mb-0.5">当前值</p>
          <p className="font-semibold text-slate-800">
            {isBudget ? "人民币玖佰捌拾万元整（¥9,800,000）" : "某省公司中心机房节能改造项目"}
          </p>
        </div>
        {[
          { label: "字段级别", v: "P0" },
        ...
        {isBudget && (
          <div className="mt-4 rounded-lg border border-[#FECDD0] bg-[#FEF1F2] p-3">
            ...
            <p className="text-[12px] text-[#A8323C] mt-1">
              商务要求（第5章）显示 ¥12,800,000，与本字段值不符。
            </p>
          </div>
        )}
      </div>
      <div className="border-t border-slate-100 p-3 space-y-2">
        <button className="w-full h-8 rounded-lg border border-[#2E5495] text-sm text-[#2E5495] hover:bg-[#F2F6FC]">
          查看字段修改记录
        </button>
        <button className="w-full h-8 rounded-lg border border-[#FECDD0] bg-[#FEF1F2] text-sm text-[#A8323C] hover:bg-[#FDDDE0]">
          申请修改字段值
        </button>
      </div>
    </div>
...
function ParagraphEvidenceDrawer({
  blockId,
  onClose,
  onAIEdit,
}: {
    ...
    <div className="flex flex-col h-full border-l border-slate-200 bg-white">
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        <div className="flex gap-3 mb-4">
          <span className="rounded px-2 py-0.5 bg-[#FFF7E6] text-[#8B520B] text-[11px] font-medium">
            AI 起草
          </span>
          <span className="rounded px-2 py-0.5 bg-slate-100 text-slate-500 text-[11px]">
            未审阅
          </span>
        </div>
        ...
        {[
          {
            src: "可研第三章 建设内容与规模",
            page: "第 24 页",
            text: "本项目拟采购 UPS 主机 2 套、蓄电池组 4 组、精密空调 6 台……",
          },
          {
            src: "可研第四章 技术方案",
            page: "第 31 页",
            text: "精密空调制冷量不低于 40kW，支持上送风/下送风两种安装方式……",
          },
        ].map((s, i) => (
          <div key={i} className="mb-3 rounded-lg border border-slate-200 bg-slate-50 p-3">
            ...
            <button className="mt-2 text-[11px] text-[#2E5495] hover:underline">
              打开来源原文
            </button>
          </div>
        ))}
      ...
      <div className="border-t border-slate-100 p-3 space-y-2">
        <button className="w-full h-8 rounded-lg border border-[#116B46] bg-[#ECF8F2] text-sm text-[#116B46] hover:bg-[#D9F2E8]">
          标记为已人工审阅
        </button>
        <button
          onClick={() => {
          ...
          className="w-full h-8 rounded-lg border border-[#2E5495] text-sm text-[#2E5495] hover:bg-[#F2F6FC]"
        >
          使用 AI 辅助修改
        </button>
      </div>
...
function AIEditDrawer({ blockId, onClose }: { blockId: string; onClose: () => void }) {
  ...
  const ORIGINAL =
    "采购设备清单包括但不限于：UPS 主机（模块化）2 套，蓄电池组 4 组，精密空调 6 台，动环监控主机 1 套，相关辅材及安装服务 1 批。";
  const SUGGESTED =
    "本次采购设备清单如下：模块化 UPS 主机 2 套、铅酸蓄电池组 4 组、精密空调 6 台（含配套末端）、动环监控主机及传感器 1 套，以及相关安装辅材与调试服务 1 批。";
  const BLOCKED_SUGGESTED =
    "本次采购 UPS 主机 5 套（原为 2 套），总采购预算调整为人民币 1280 万元整。";
      ...
      <div className="flex-1 overflow-y-auto p-4">
        ...
        {step === "blocked" && isBlocked && (
          <div className="mb-4 rounded-lg border border-[#FECDD0] bg-[#FEF1F2] p-4">
            <p className="text-sm font-semibold text-[#A8323C] mb-2">
              无法应用：涉及已确认关键字段
            </p>
            <p className="text-[13px] text-[#A8323C] leading-5">
              该建议修改涉及已确认关键字段（设备数量、招标预算），不能直接应用到正文。
            </p>
            <div className="mt-3 space-y-2">
              <button className="w-full h-8 rounded border border-[#FECDD0] text-sm text-[#A8323C] hover:bg-[#FDDDE0]">
                查看涉及字段
              </button>
              <button className="w-full h-8 rounded border border-slate-300 text-sm text-slate-600 hover:bg-slate-50">
                返回字段确认
              </button>
              <button
                onClick={() => {
                ...
                className="w-full h-8 rounded border border-slate-300 text-sm text-slate-600 hover:bg-slate-50"
              >
                放弃建议
              </button>
            </div>
          ...
          <>
            ...
            <div className="mb-3 space-y-1">
              {MODES.map((m) => (
                <label
                  key={m.v}
                  className="flex items-center gap-2 rounded-lg px-2 py-2 hover:bg-slate-50 cursor-pointer text-[13px] text-slate-700"
                >
                  <input
                    type="radio"
                    value={m.v}
            ...
            {mode === "add_quantity" && (
              <textarea
                ...
                rows={3}
                placeholder="请在不改变设备数量和技术指标的前提下…"
            ...
            <div className="mb-4 rounded-lg border border-[#DCE7F7] bg-[#F6F8FB] p-3">
              <p className="text-[11px] font-semibold text-[#24457C] mb-1.5">
                强制约束（不可修改）
              </p>
              ...
              <div className="mb-4">
                ...
                <div className="mt-3 rounded-lg border border-slate-200 bg-slate-50 p-3 text-[12px]">
                  <div className="flex justify-between mb-1">
                    <span className="text-slate-500">修改依据</span>
                    <span className="text-slate-700">当前字段快照与来源材料</span>
                  </div>
                  <div className="flex justify-between mb-1">
                    <span className="text-slate-500">影响字段</span>
                    <span className="text-[#116B46]">无</span>
                  </div>
                  <div className="flex justify-between">
                    <span className="text-slate-500">风险提示</span>
                    <span className="text-slate-700">未改变确定性字段</span>
                  </div>
                </div>
              </div>
            )}
      ...
      {step !== "blocked" && (
        <div className="border-t border-slate-100 p-3 space-y-2">
          ...
          {step === "generating" && (
            <button
              disabled
              className="w-full h-9 rounded-lg bg-[#2E5495] text-sm font-medium text-white flex items-center justify-center gap-2 opacity-70"
            >
              <svg
                width="14"
                height="14"
          ...
          {step === "diff" && (
            <>
              <button
                ...
                className="w-full h-9 rounded-lg bg-[#116B46] text-sm font-medium text-white hover:bg-[#0E5838]"
              >
                应用修改
              </button>
              <button
                onClick={generate}
                className="w-full h-8 rounded-lg border border-slate-300 text-sm text-slate-600 hover:bg-slate-50"
              >
                重新生成
              </button>
              <button
          ...
          {step === "applied" && (
            <div className="rounded-lg border border-[#C3E8D5] bg-[#ECF8F2] p-3 text-[13px] text-[#116B46] flex items-center gap-2">
              <Icon name="check-circle" size={14} />
              修改已应用，状态：AI 修改，待人工确认
            </div>
          )}
        </div>
      )}
  ...
  return (
    <div className="flex flex-col h-full border-l border-slate-200 bg-white">
      ...
      <div className="flex gap-1 px-3 py-2 border-b border-slate-100 overflow-x-auto">
        {["all", "P0", "P1", "P2", "resolved"].map((f) => (
          <button
            key={f}
            onClick={() => setFilter(f)}
            className={`shrink-0 h-6 rounded-full px-3 text-[11px] font-medium ${
              filter === f
                ? "bg-[#2E5495] text-white"
                : "border border-slate-300 text-slate-500 hover:border-[#2E5495]"
            }`}
          >
      ...
      <div className="flex-1 overflow-y-auto">
        {filtered.length === 0 && (
          <p className="text-center py-8 text-sm text-slate-400">暂无问题</p>
        )}
        {filtered.map((issue) => (
          <div
            key={issue.id}
            className={`border-b border-slate-100 p-4 ${issue.resolved ? "opacity-50" : ""}`}
          >
            ...
            {!issue.resolved && (
              <div className="flex gap-2 flex-wrap">
                <button className="h-6 rounded border border-slate-300 px-2 text-[11px] text-slate-600 hover:border-[#2E5495]">
                  定位到正文
                </button>
                <button
      ...
      <div className="border-t border-slate-100 p-3">
        <button
          onClick={onViewFull}
          className="w-full h-8 rounded-lg border border-slate-300 text-sm text-slate-600 hover:border-[#2E5495]"
        >
          查看完整校验报告
        </button>
      </div>
...
function FinalizeDocumentDialog({
  onClose,
  onConfirm,
}: {
  onClose: () => void;
        ...
        <div className="p-6">
              ...
              <div key={k} className="flex justify-between gap-3">
                ...
                <span
                  className={`text-right font-medium ${
                    v === "已通过" ? "text-[#116B46]" : "text-slate-800"
                  }`}
                >
                  {v}
                </span>
          ...
          <div className="mb-4">
            ...
            <textarea
              ...
              rows={2}
              placeholder="例如：已完成项目、采购、技术和商务部门联合审校。"
          ...
          <label className="flex items-start gap-3 mb-5 cursor-pointer">
            <input
              ...
              className="mt-0.5 accent-[#2E5495]"
            />
          ...
          <div className="rounded-lg border border-[#DCE7F7] bg-[#F6F8FB] p-3 text-[13px] text-[#24457C] mb-5">
            <Icon name="info" size={13} /> 定稿后，V1.0
            将锁定为只读版本。后续修改需要创建新的修订草稿。
          </div>
        ...
        <div className="p-6">
          ...
          <div className="mb-4 space-y-1">
            {FORMATS.map((f) => (
              <label
                key={f.v}
                className="flex items-center gap-2 rounded-lg px-3 py-2 hover:bg-slate-50 cursor-pointer text-[13px] text-slate-700"
              >
                <input
                  type="radio"
                  value={f.v}
  ...
  return (
    <div className="fixed inset-0 z-40 grid place-items-center bg-slate-950/25 p-6">
      <div className="w-full max-w-[440px] rounded-xl border border-slate-200 bg-white shadow-[0_18px_48px_rgba(15,23,42,.18)] p-6">
        ...
        <div className="space-y-3 mb-6">
          {steps.map((s, i) => (
            <div key={s} className="flex items-center gap-3">
              <span
                className={`shrink-0 ${
                  i < done ? "text-[#116B46]" : i === done ? "text-[#2E5495]" : "text-slate-300"
                }`}
              >
                {i < done ? (
        ...
        <button
          onClick={onBack}
          className="w-full h-9 rounded-lg border border-slate-300 text-sm text-slate-600 hover:border-[#2E5495]"
        >
          后台导出并返回项目详情
        </button>
      </div>
    ...
    >
      <div className="w-full max-w-[440px] rounded-xl border border-slate-200 bg-white shadow-[0_18px_48px_rgba(15,23,42,.18)] p-6 text-center">
        ...
        <div className="mb-4 rounded-lg border border-slate-200 bg-slate-50 p-3 text-[13px]">
          {[
            ["文件大小", "4.2 MB"],
            ["生成时间", "2026-09-05 15:10"],
            ["文件校验", "通过"],
          ].map(([k, v]) => (
            <div key={k} className="flex justify-between">
              <span className="text-slate-500">{k}</span>
              <span className={`font-medium ${v === "通过" ? "text-[#116B46]" : "text-slate-700"}`}>
                {v}
              </span>
            </div>
          ))}
        ...
        <button
          onClick={onDownload}
          className="w-full h-10 rounded-lg bg-[#2E5495] text-sm font-medium text-white hover:bg-[#24457C] mb-2"
        >
          下载文件
        </button>
        <div className="flex gap-2">
          <button className="flex-1 h-8 rounded-lg border border-slate-300 text-sm text-slate-600 hover:bg-slate-50">
            复制链接
          </button>
          <button className="flex-1 h-8 rounded-lg border border-slate-300 text-sm text-slate-600 hover:bg-slate-50">
            导出 PDF
          ...
          <button
            onClick={onClose}
            className="flex-1 h-8 rounded-lg border border-slate-300 text-sm text-slate-600 hover:bg-slate-50"
          >
            关闭
          </button>
        </div>
  ...
  return (
    <div className="flex items-start gap-3 border-b border-[#DCE7F7] bg-[#F2F6FC] px-5 py-3 text-[13px] shrink-0">
      ...
      <p className="flex-1 text-[#24457C]">
        <strong>来源可研报告已有新版本：</strong>当前招标文件依据可研 V1.3，最新版本为
        V1.4。当前文件不会自动更新。
      </p>
      <div className="flex gap-2 shrink-0">
        <button className="h-6 rounded border border-[#2E5495] px-2 text-[11px] text-[#2E5495] hover:bg-[#DCE7F7]">
          查看影响字段
        </button>
        <button className="h-6 rounded border border-[#2E5495] px-2 text-[11px] text-[#2E5495] hover:bg-[#DCE7F7]">
          继续使用 V1.3
        </button>
        <button onClick={onDismiss} className="text-[#2E5495] hover:text-[#24457C]">
  ...
  return (
    <div className="flex items-start gap-3 border-b border-[#FDDBA0] bg-[#FFF7E6] px-5 py-3 text-[13px] shrink-0">
      ...
      <p className="flex-1 text-[#8B520B]">
        <strong>模板已有新版本：</strong>当前文件使用货物类公开招标文件模板 V3.0，模板中心最新版本为
        V3.1。当前文件不受影响。
      </p>
      <div className="flex gap-2 shrink-0">
        <button className="h-6 rounded border border-[#8B520B] px-2 text-[11px] text-[#8B520B] hover:bg-[#FDDBA0]">
          查看差异
        </button>
        <button className="h-6 rounded border border-[#8B520B] px-2 text-[11px] text-[#8B520B] hover:bg-[#FDDBA0]">
          继续使用 V3.0
        </button>
        <button onClick={onDismiss} className="text-[#8B520B]">
          <Icon name="close" size={13} />
        </button>
      </div>
    </div>
    ...
    <div className="fixed inset-0 z-40 grid place-items-center bg-slate-950/25 p-6">
      <div className="w-full max-w-[500px] rounded-xl border border-slate-200 bg-white shadow-[0_18px_48px_rgba(15,23,42,.18)] p-6">
        ...
        <div className="space-y-2">
          <button className="w-full h-10 rounded-lg bg-[#2E5495] text-sm font-medium text-white hover:bg-[#24457C]">
            查看差异并合并
          </button>
          <button className="w-full h-10 rounded-lg border border-slate-300 text-sm text-slate-600 hover:border-[#2E5495]">
            保存为我的修改副本
          </button>
          <button onClick={onClose} className="w-full text-sm text-[#A8323C] hover:underline py-1">
            放弃我的修改并加载最新版
          </button>
        </div>
      </div>
...
function FinalizedCompletedView({
  navigate,
  onExport,
}: {
  navigate: (p: Page) => void;
    ...
    <div className="flex flex-1 min-h-0 flex-col overflow-hidden">
      ...
      <div className="flex h-14 shrink-0 items-center gap-3 border-b border-slate-200 bg-white px-6">
        <button
          ...
          className="flex items-center gap-1.5 text-xs text-slate-500 hover:text-[#24457C]"
        >
          <Icon name="arrow" size={13} />
          项目详情
        </button>
        ...
        <span className="rounded-full bg-[#ECF8F2] px-2.5 py-0.5 text-[11px] font-medium text-[#116B46]">
          V1.0 · 已定稿
        </span>
      </div>
        ...
        <div className="w-full max-w-[640px]">
          <div className="mb-8 rounded-2xl border border-[#C3E8D5] bg-white p-8 text-center">
            ...
            <div className="mx-auto max-w-sm space-y-2 text-[13px] mb-6">
              {[
                ...
                <div key={k} className="flex justify-between">
                  ...
                  <span
                    className={`font-medium ${
                      v === "已定稿" || v === "已通过" ? "text-[#116B46]" : "text-slate-800"
                    }`}
                  >
                    {v}
                  </span>
            ...
            <div className="flex gap-2 mb-4">
              <button className="flex-1 h-9 rounded-lg border border-slate-300 text-sm text-slate-600 hover:bg-slate-50">
                导出 PDF
              </button>
              <button className="flex-1 h-9 rounded-lg border border-slate-300 text-sm text-slate-600 hover:bg-slate-50">
                查看校验报告
...
function VersionMenu({ onClose, navigate }: { onClose: () => void; navigate: (p: Page) => void }) {
  return (
    <div className="fixed inset-0 z-20" onClick={onClose}>
      <div
        className="absolute right-24 top-14 w-56 rounded-lg border border-slate-200 bg-white py-1 shadow-lg"
        onClick={(e) => e.stopPropagation()}
      >
        <p className="px-4 py-2 text-[11px] text-slate-500 font-semibold uppercase tracking-wide border-b border-slate-100">
          版本对比
        </p>
        <button
          onClick={() => {
            navigate("document-compare");
            onClose();
          }}
...
export function DocumentWorkspacePage({
  ...
  if (showFinalizedComplete) {
    return (
      <FinalizedCompletedView
        navigate={navigate}
        onExport={() => {
          setShowFinalizedComplete(false);
          handleExport();
        }}
      />
    );
  ...
  return (
    <div className="flex flex-1 min-h-0 flex-col overflow-hidden">
      {/* Banners */}
      {showSourceChanged && (
        <SourceChangedBannerDoc onDismiss={() => setShowSourceChanged(false)} />
      )}
      {showTemplateChanged && (
        <TemplateChangedBannerDoc onDismiss={() => setShowTemplateChanged(false)} />
      )}
      {saveStatus === "failed" && (
        <div className="flex items-center gap-3 border-b border-[#FECDD0] bg-[#FEF1F2] px-5 py-2.5 shrink-0">
          <Icon name="alert" size={14} />
          <p className="flex-1 text-[13px] text-[#A8323C]">
            <strong>自动保存失败。</strong>
            当前修改已保留在本地，请检查网络后重新保存。
          </p>
          <div className="flex gap-2 shrink-0">
            <button
              onClick={() => setSaveStatus("saving")}
              className="h-6 rounded border border-[#A8323C] px-2 text-[11px] text-[#A8323C] hover:bg-[#FDDDE0]"
            >
              重新保存
            </button>
            <button className="h-6 rounded border border-[#A8323C] px-2 text-[11px] text-[#A8323C] hover:bg-[#FDDDE0]">
              下载副本
            </button>
          </div>
        </div>
      ...
      <DocumentToolbar
        ...
        onToggleMarkers={() => setShowMarkers((m) => !m)}
      ...
      <div className="flex flex-1 min-h-0 overflow-hidden">
          ...
          <div className="mx-auto" style={{ maxWidth: zoom === 125 ? "100%" : "794px" }}>
            {SECTIONS.map((section) => (
              <div
                ...
                className="mb-6 bg-white shadow-sm rounded-sm px-14 py-10"
                ...
                <div className="pl-8">
                  {(BLOCKS[section.id] || []).map((block) => (
                    <ContentBlockView
                      ...
                      onFieldClick={(key) => {
                        setFieldKey(key);
                        openPanel("field-evidence");
                      }}
                      onParagraphSourceClick={(bid) => {
                        setParagraphBlockId(bid);
                        openPanel("paragraph-evidence");
                      }}
                      onAIEditRequest={(bid) => {
                        setAIBlockId(bid);
                        openPanel("ai-edit");
        ...
        {rightPanel && (
          <div className="w-[400px] shrink-0 flex flex-col overflow-hidden">
            {rightPanel === "field-evidence" && (
              <FieldEvidenceDrawer fieldKey={fieldKey} onClose={() => setRightPanel(null)} />
            )}
            {rightPanel === "paragraph-evidence" && (
              <ParagraphEvidenceDrawer
                blockId={paragraphBlockId}
                onClose={() => setRightPanel(null)}
                onAIEdit={() => setRightPanel("ai-edit")}
              />
            )}
            {rightPanel === "ai-edit" && (
              <AIEditDrawer blockId={aiBlockId} onClose={() => setRightPanel(null)} />
            )}
      ...
      {isFinalized && !showFinalizedComplete && (
        <div className="fixed bottom-6 left-1/2 -translate-x-1/2 flex items-center gap-4 rounded-xl border border-[#C3E8D5] bg-white px-5 py-3 shadow-lg z-10">
          ...
          <button className="h-8 rounded-lg border border-slate-300 px-3 text-sm text-slate-600 hover:bg-slate-50">
            创建修订版本
          </button>
          <button
            onClick={() => navigate("contract-source")}
            className="h-8 rounded-lg border border-[#2E5495] px-3 text-sm text-[#2E5495] hover:bg-[#F2F6FC]"
          >
            进入合同阶段
          </button>
        </div>
      ...
      {showExportDialog && (
        <ExportDocumentDialog onClose={() => setShowExportDialog(false)} onStart={startExport} />
      )}
      ...
      {exportState === "completed" && (
        <ExportCompleted
          ...
          onDownload={() => setExportState("idle")}
        />
      )}
      {showRevisionConflict && (
        <RevisionConflictDialog onClose={() => setShowRevisionConflict(false)} />
      )}
      {showVersionMenu && (
        <VersionMenu onClose={() => setShowVersionMenu(false)} navigate={navigate} />
      )}
    </div>
  );
}
