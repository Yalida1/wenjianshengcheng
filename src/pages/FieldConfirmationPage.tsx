...
const STATUS_CLS: Record<FieldStatus, string> = {
  pending: "bg-[#FFF7E6] text-[#8B520B]",
  confirmed: "bg-[#ECF8F2] text-[#116B46]",
  conflict: "bg-[#FFF3E0] text-[#8B4A00]",
  missing: "bg-[#FEF1F2] text-[#A8323C]",
  "ai-suggested": "bg-[#EEF2FF] text-[#3B5BCC]",
  "reference-only": "bg-slate-100 text-slate-600",
  invalid: "bg-[#FEF1F2] text-[#A8323C]",
...
const INITIAL_FIELDS: Field[] = [
    ...
    evidence: [
      {
        ...
        chapter: "第一章 项目概况",
        page: 6,
        excerpt: "本项目名称为某省公司中心机房节能改造项目，建设单位为某省通信有限公司……",
        version: "V1.3",
        confidence: 98,
        source: "文档结构识别 + 语义抽取",
      },
    ...
    evidence: [
      {
        ...
        chapter: "第一章，第 8 页",
        page: 8,
        excerpt: "项目建设地点为某省某市高新区中心机房，现有机房面积……",
        version: "V1.3",
        confidence: 95,
        source: "语义抽取",
      },
  ...
  },
  {
    ...
    criticality: "P1",
    status: "confirmed",
    value: "现有机房 PUE 值达 2.1，高于行业节能标准",
    groupId: "projectInfo",
    evidence: [
      {
        id: "e5",
        chapter: "第一章 项目背景",
        page: 5,
        excerpt: "目前机房 PUE 值达 2.1，远高于国家绿色数据中心 PUE≤1.5 的要求……",
        version: "V1.3",
        confidence: 92,
        source: "语义抽取",
      },
    ...
    confirmedBy: "王明远",
    confirmedAt: "2026-09-05 10:34",
  },
  {
    id: "f6",
    key: "project.approval_doc",
    name: "立项批复文号",
    criticality: "P1",
    status: "confirmed",
    value: "某通信〔2026〕52 号",
  ...
  {
    id: "f8",
    key: "procurement.scope",
    name: "本次采购范围",
    criticality: "P0",
    status: "pending",
    value: "已识别 9 项建设内容，尚未确定哪些属于本次采购范围",
    groupId: "procurementScope",
    ...
    evidence: [
      {
        ...
        page: 18,
        excerpt:
          "本次节能改造工程主要包含机房基础环境改造、UPS 主机采购、蓄电池组采购、精密空调采购、动环监控系统、综合布线、安装调试、用户培训和三年运维服务共九项内容……",
        version: "V1.3",
        confidence: 85,
        source: "语义抽取",
      },
  ...
  {
    id: "f12",
    key: "tech.energy_target",
    name: "节能效率目标",
    criticality: "P1",
    status: "confirmed",
    value: "改造后 PUE ≤ 1.5",
    groupId: "techRequirements",
    evidence: [],
    confirmedBy: "王明远",
    confirmedAt: "2026-09-05 10:36",
  },
  {
    id: "f13",
    key: "tech.pue",
  ...
  },
  {
    ...
    conflicts: [
      {
        id: "c1",
        value: "GB 50174-2017 数据中心设计规范",
        chapter: "第五章 技术要求",
        page: 38,
        excerpt: "本项目应遵循 GB 50174-2017 数据中心设计规范执行……",
        confidence: 82,
      },
      {
        id: "c2",
        value: "T/CEC 201-2019 数据中心绿色等级评价标准",
        chapter: "第四章 建设标准",
        page: 28,
        excerpt: "依据 T/CEC 201-2019 绿色数据中心评价要求……",
        confidence: 76,
      },
    ],
  },
  {
    ...
    evidence: [],
    confirmedBy: "王明远",
    confirmedAt: "2026-09-05 10:37",
  },
  {
    id: "f16",
    key: "tech.qualification",
    name: "制造商资质要求",
    criticality: "P2",
    status: "confirmed",
    value: "ISO 9001 认证",
  ...
  {
    id: "f17",
    key: "procurement.equipment_quantity",
    name: "设备数量",
    criticality: "P1",
    status: "conflict",
    value: "存在 2 个候选值",
    groupId: "equipmentList",
    evidence: [],
    conflicts: [
      {
        id: "c3",
  ...
  },
  {
    ...
    criticality: "P1",
    status: "confirmed",
    value: "2 台（200kVA 模块化）",
    groupId: "equipmentList",
    evidence: [],
    confirmedBy: "王明远",
    confirmedAt: "2026-09-05 10:38",
  },
  {
    id: "f19",
    key: "equipment.battery",
    name: "蓄电池组数量",
    criticality: "P1",
    status: "confirmed",
    value: "4 组（2V×240 节）",
  ...
  {
    id: "f22",
    key: "procurement.delivery_location",
    name: "交付地点",
    criticality: "P1",
    status: "pending",
    value: "某省某市高新区中心机房",
  ...
  {
    id: "f23",
    key: "procurement.delivery_period",
    name: "本次招标交付周期",
    criticality: "P0",
    status: "ai-suggested",
    value: "项目建设周期 12 个月",
    ...
    evidence: [
      {
        ...
        chapter: "第二章 建设期",
        page: 15,
        excerpt: "项目计划建设周期为 12 个月，自合同签订之日起算……",
        version: "V1.3",
        confidence: 72,
        source: "AI 上下文推断",
      },
  ...
  {
    id: "f24",
    key: "procurement.install_period",
    name: "安装调试周期",
    criticality: "P1",
    status: "confirmed",
    value: "60 天",
    ...
    evidence: [],
    confirmedBy: "王明远",
    confirmedAt: "2026-09-05 10:39",
  },
  {
    id: "f25",
    key: "procurement.acceptance_period",
    name: "验收周期",
    criticality: "P1",
    status: "confirmed",
    value: "30 天",
    ...
    evidence: [
      {
        ...
        chapter: "第八章 投资估算",
        page: 72,
        excerpt: "本项目总投资估算约 1,280 万元，其中建设投资……",
        version: "V1.3",
        confidence: 94,
        source: "表格提取",
      },
  ...
  },
  {
    ...
    evidence: [],
    confirmedBy: "王明远",
    confirmedAt: "2026-09-05 10:40",
  },

  // acceptance (5): 3 confirmed, 1 pending, 1 missing
  {
    id: "f29",
    key: "procurement.acceptance_req",
    name: "验收要求",
    criticality: "P1",
    status: "pending",
    value: "已识别 5 项验收要求",
    ...
    evidence: [
      {
        ...
        chapter: "第七章 验收标准",
        page: 65,
        excerpt: "验收应包括：性能测试、安全检查、文档移交、培训完成及试运行稳定……",
        version: "V1.3",
        confidence: 88,
        source: "语义抽取",
      },
  ...
  {
    id: "f30",
    key: "procurement.acceptance_std",
    name: "验收标准文件",
    criticality: "P1",
    status: "confirmed",
    value: "遵循国家相关行业标准",
    ...
    evidence: [],
    confirmedBy: "陈昊",
    confirmedAt: "2026-09-05 11:05",
  },
  {
    id: "f31",
    key: "procurement.trial_run",
    name: "试运行周期",
    criticality: "P1",
    status: "confirmed",
    value: "90 天",
  ...
  {
    id: "f32",
    key: "procurement.perf_guarantee",
    name: "履约担保比例",
    criticality: "P1",
    status: "confirmed",
    value: "合同金额 10%",
    ...
    evidence: [],
    confirmedBy: "王明远",
    confirmedAt: "2026-09-05 10:41",
  },
  {
    id: "f33",
    key: "procurement.warranty",
    name: "质保期",
    criticality: "P1",
    status: "missing",
    value: "未找到",
  ...
  },
  {
    ...
    conflicts: [
      {
        id: "c5",
        value: "提供不少于 2 年所需备品备件",
        chapter: "第七章 服务要求",
        page: 63,
        excerpt: "供方应提供不少于 2 年的备品备件清单和采购渠道……",
        confidence: 79,
      },
      {
        id: "c6",
        value: "提供不少于 1 年所需备品备件",
        chapter: "第五章 技术规格",
        page: 42,
        excerpt: "备品备件供应期限不少于 1 年……",
        confidence: 73,
      },
    ],
  },
...
function FieldStatusBadge({ status }: { status: FieldStatus }) {
  return (
    <span
      className={`inline-flex h-5 items-center gap-1 rounded px-1.5 text-[11px] font-medium ${STATUS_CLS[status]}`}
    >
      {STATUS_LABEL[status]}
    </span>
  );
...
function FieldCriticalityBadge({ criticality }: { criticality: FieldCriticality }) {
  return (
    <span
      className={`inline-flex h-5 items-center rounded px-1.5 font-mono text-[11px] font-bold ${CRIT_CLS[criticality]}`}
    >
      {criticality}
    </span>
  );
          ...
          <div className="space-y-4">
            {field.evidence.map((ev) => (
              <div key={ev.id} className="rounded-lg border border-slate-200 bg-white p-4">
                ...
                {ev.source && <p className="mt-2 text-xs text-slate-400">提取方式：{ev.source}</p>}
                ...
                {field.conflicts.map((c) => (
                  <div key={c.id} className="rounded-lg border border-orange-200 bg-orange-50 p-3">
                    ...
                    <p className="mt-1 text-xs text-slate-500">
                      {c.chapter}，第 {c.page} 页 · 置信度 {c.confidence}%
                    </p>
...
function ConflictResolutionDialog({
  ...
  return (
    <div
      className="fixed inset-0 z-30 flex items-center justify-center bg-slate-950/30 p-6"
      onClick={(e) => {
    ...
    >
      <div className="w-full max-w-[920px] max-h-[calc(100vh-96px)] overflow-auto rounded-xl border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,.2)]">
        <div className="flex items-start justify-between border-b border-slate-200 px-7 py-5">
          <div>
            ...
            <p className="mt-1 text-[13px] text-slate-500">
              字段：<strong>{field.name}</strong>
              　系统在不同章节识别到多个候选值，请选择正确值或输入最终确认值。
            </p>
          </div>
          <button onClick={onClose} className="rounded p-1 text-slate-400 hover:bg-slate-100">
            <Icon name="close" />
        ...
        <div className="p-7">
            ...
            {(field.conflicts ?? []).map((c, idx) => (
              <label
                ...
                className={`cursor-pointer rounded-xl border-2 p-5 transition-all ${
                  selected === c.id && !useCustom
                    ? "border-[#2E5495] bg-[#F2F6FC]"
          ...
          <div
            className={`mt-4 rounded-xl border-2 p-5 cursor-pointer transition-all ${
              useCustom
                ? "border-[#2E5495] bg-[#F2F6FC]"
                : "border-slate-200 hover:border-slate-300"
            }`}
          ...
          >
            <div className="flex items-center justify-between mb-3">
              ...
              <div
                className={`size-5 rounded-full border-2 flex items-center justify-center ${
                  useCustom ? "border-[#2E5495] bg-[#2E5495]" : "border-slate-300"
                }`}
              >
            ...
            {useCustom && (
              <div className="grid grid-cols-3 gap-3" onClick={(e) => e.stopPropagation()}>
                <input
                  autoFocus
                  className="col-span-2 h-9 rounded-lg border border-slate-300 px-3 text-sm focus:border-[#2E5495] focus:outline-none focus:ring-2 focus:ring-[#DCE7F7]"
                  placeholder="输入最终确认值"
                  value={customValue}
                  onChange={(e) => setCustomValue(e.target.value)}
                />
                <input
                  className="h-9 rounded-lg border border-slate-300 px-3 text-sm focus:border-[#2E5495] focus:outline-none focus:ring-2 focus:ring-[#DCE7F7]"
                  placeholder="单位（可选）"
                />
              </div>
            )}
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-200 px-7 py-4">
          <button
            onClick={onClose}
            className="h-10 rounded-lg border border-slate-300 bg-white px-5 text-sm font-medium text-slate-700 hover:border-[#2E5495] hover:text-[#24457C]"
          >
            取消
          </button>
          <button
            ...
            onClick={() => {
              const val = useCustom
                ? customValue
                : (field.conflicts?.find((c) => c.id === selected)?.value ?? "");
              onSave(val, reason);
              onClose();
            }}
...
function ManualInputDialog({
  ...
  field: Field;
  onClose: () => void;
  onSave: (value: string, source: string) => void;
}) {
    ...
    >
      <div className="w-full max-w-[600px] rounded-xl border border-slate-200 bg-white shadow-[0_20px_60px_rgba(15,23,42,.2)]">
        ...
        <div className="p-6">
          ...
          <div className="mb-5 rounded-lg border border-[#DCE7F7] bg-[#F6F8FB] p-4">
            ...
            <p className="text-sm text-slate-700">
              可研项目总投资：<strong>1,280 万元</strong>
            </p>
            <p className="mt-1 text-xs text-[#8B520B]">
              ⚠ 仅供参考，不会自动带入招标预算，也不会自动等同合同金额。
            </p>
          </div>
          ...
          <div className="space-y-4">
            <div className="grid grid-cols-3 gap-3">
              <div className="col-span-2">
                ...
                <input
                  autoFocus
                  className="h-10 w-full rounded-lg border border-slate-300 px-3 text-sm focus:border-[#2E5495] focus:outline-none focus:ring-2 focus:ring-[#DCE7F7]"
                  placeholder="例如：800"
                  value={amount}
              ...
              <div>
                ...
                <select
                  className="h-10 w-full rounded-lg border border-slate-300 bg-white px-3 text-sm focus:border-[#2E5495] focus:outline-none"
                  value={currency}
                ...
                {["含税", "不含税", "待定"].map((opt) => (
                  <label key={opt} className="flex items-center gap-2 text-sm cursor-pointer">
                    <input
                      ...
                      name="tax"
                      value={opt}
                      checked={taxIncluded === opt}
                      onChange={() => setTaxIncluded(opt)}
                    />
                    {opt}
                  </label>
                ))}
        ...
        <div className="flex items-center justify-end gap-3 border-t border-slate-200 px-6 py-4">
          <button
            onClick={onClose}
            className="h-10 rounded-lg border border-slate-300 bg-white px-5 text-sm font-medium text-slate-700 hover:border-[#2E5495]"
          >
            取消
          </button>
          <button
...
function ScopeSelectionDialog({
  ...
  const [checked, setChecked] = useState<string[]>(
    initialChecked.length > 0 ? initialChecked : SCOPE_ITEMS.slice(0, 6),
  );
          ...
          <div className="w-[340px] shrink-0 border-r border-slate-200 flex flex-col">
            <div className="flex items-center justify-between border-b border-slate-100 px-5 py-3">
              ...
              <div className="flex gap-3">
                <button
                  className="text-xs text-[#2E5495] hover:underline"
                  onClick={() => setChecked([...SCOPE_ITEMS])}
                >
                  全选
                </button>
                <button
              ...
              {SCOPE_ITEMS.map((item) => (
                <label
                  ...
                  className={`flex cursor-pointer items-center gap-3 rounded-lg px-3 py-2.5 transition-colors ${
                    selected === item ? "bg-[#F2F6FC]" : "hover:bg-slate-50"
                  }`}
                ...
                >
                  ...
                  <span
                    className={`text-sm ${
                      checked.includes(item) ? "text-slate-800" : "text-slate-400 line-through"
                    }`}
                  >
                    {item}
                  </span>
            ...
            <div className="space-y-4">
                  ...
                  {["包含", "不包含"].map((opt) => (
                    <label key={opt} className="flex items-center gap-2 text-sm cursor-pointer">
                      <input
                        ...
                        defaultChecked={opt === "包含" && checked.includes(selected)}
                      />
                      {opt}
                    </label>
                  ))}
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  ...
                  <input
                    className="h-9 w-full rounded-lg border border-slate-300 px-3 text-sm focus:border-[#2E5495] focus:outline-none"
                    placeholder="数量"
                  />
                </div>
                <div>
              ...
              <div>
                ...
                <textarea
                  rows={2}
                  className="w-full resize-none rounded-lg border border-slate-300 p-3 text-sm focus:border-[#2E5495] focus:outline-none"
    ...
    <div className="border-b border-blue-200 bg-[#EFF6FF] px-6 py-3">
      <div className="flex items-start justify-between gap-4">
        ...
        <div className="flex shrink-0 items-center gap-3">
          <button className="h-8 rounded-lg bg-[#2563EB] px-4 text-xs font-medium text-white hover:bg-[#1D4ED8]">
            查看差异
          </button>
          <button
            onClick={onDismiss}
            className="h-8 rounded-lg border border-blue-300 bg-white px-4 text-xs font-medium text-[#2563EB] hover:bg-blue-50"
          >
            继续使用 V1.3
          </button>
          <button className="text-xs text-[#6B7280] hover:text-[#374151]">
            重新基于 V1.4 提取
          </button>
        </div>
      </div>
  ...
  return (
    <div className="flex items-center gap-3 border-b border-amber-200 bg-amber-50 px-6 py-2.5">
      ...
      <p className="text-sm text-amber-800">
        <strong>只读模式</strong>
        　招标文件已定稿，当前字段快照已被后续文件使用。 锁定人：陈昊　锁定时间：2026-09-05 14:20
      </p>
...
function FieldConfirmationHeader({
  fields,
  navigate,
  readOnly,
}: {
  ...
  const pending = fields.filter((f) =>
    ["pending", "ai-suggested", "reference-only"].includes(f.status),
  ).length;
  const conflict = fields.filter((f) => f.status === "conflict").length;
  const missing = fields.filter((f) => f.status === "missing").length;
  const p0Blocked = fields.filter(
    (f) => f.criticality === "P0" && !["confirmed", "not-applicable"].includes(f.status),
  ).length;
    ...
    <div className="border-b border-slate-200 bg-white px-6 py-4 xl:px-8">
      ...
      <div className="flex items-start justify-between gap-6 flex-wrap">
        <div className="min-w-0">
          ...
          <p className="mt-1 text-[13px] text-slate-500">
            请核对从可研报告中识别的信息。只有经过确认的关键字段才能用于生成招标文件。
          </p>
          <div className="mt-3 flex flex-wrap items-center gap-x-5 gap-y-1 text-xs text-slate-500">
            ...
            <span>
              使用版本：<strong className="text-slate-700">V1.3</strong>
            </span>
            <span className="flex items-center gap-1 text-[#116B46]">
              <Icon name="lock" size={11} />
              已锁定 · 2026-09-05 10:32
            </span>
            <button className="flex items-center gap-1 text-[#2E5495] hover:underline">
        ...
        <div className="shrink-0 flex items-end gap-6">
          ...
          <div className="flex items-center gap-4">
            {[
              ...
              { label: "未找到", value: missing, cls: "text-[#A8323C]" },
              {
                label: "P0 阻断",
                value: p0Blocked,
                cls: `font-bold ${p0Blocked > 0 ? "text-[#A8323C]" : "text-[#116B46]"}`,
              },
            ].map((s) => (
          ...
          <div className="w-[120px]">
            ...
            <div className="h-1.5 rounded-full bg-slate-200">
              <div
                className="h-full rounded-full bg-[#2E5495] transition-all"
                style={{ width: `${pct}%` }}
              />
            </div>
          </div>
      ...
      <div className="p-3">
        <button
          ...
          className={`w-full rounded-lg px-3 py-2.5 text-left transition-colors ${
            currentGroup === "all"
              ? "border-l-[3px] border-[#2E5495] bg-[#F2F6FC] text-[#24457C]"
          ...
          return (
            ...
            >
              ...
              <div className="mt-1 flex flex-wrap gap-x-3 gap-y-0.5 text-[11px]">
                ...
                {s.pending > 0 && !isActive && (
                  <span className="text-[#8B520B]">{s.pending} 待确认</span>
                )}
              </div>
            </button>
          );
    ...
    <div className="shrink-0 border-b border-slate-200 bg-white px-6 py-3 xl:px-8">
      <div className="flex flex-wrap items-center gap-3">
        ...
        <label className="relative">
          ...
          <input
            className="h-9 w-56 rounded-lg border border-slate-300 bg-white pl-9 pr-3 text-sm focus:border-[#2E5495] focus:outline-none focus:ring-2 focus:ring-[#DCE7F7]"
        ...
        <button
          ...
          className={`h-9 rounded-lg border px-3 text-[12px] font-medium transition-colors ${
            onlyBlocked
              ? "border-[#C2414B] bg-[#FEF1F2] text-[#A8323C]"
              : "border-slate-300 bg-white text-slate-600 hover:border-[#2E5495] hover:text-[#24457C]"
          }`}
        >
...
function FieldRowItem({
  ...
  field: Field;
  readOnly: boolean;
  onViewEvidence: (f: Field) => void;
  onConfirm: (id: string) => void;
  onResolveConflict: (f: Field) => void;
  onManualInput: (f: Field) => void;
  onSelectScope: () => void;
}) {
  ...
  const isBlocking =
    field.criticality === "P0" && !["confirmed", "not-applicable"].includes(field.status);

  return (
    <article
      className={`border-b border-slate-100 px-5 py-4 transition-colors hover:bg-[#FBFCFE] ${
        isBlocking ? "border-l-2 border-l-[#C2414B]" : ""
      }`}
    >
      ...
      {field.note && field.note !== "scope-selection" && (
        <div
          className={`mt-2 flex items-start gap-2 rounded-md px-3 py-2 text-xs leading-5 ${
            field.status === "reference-only"
              ? "border-l-2 border-slate-300 bg-slate-50 text-slate-600"
              : field.status === "ai-suggested"
                ? "border-l-2 border-[#3B5BCC] bg-[#EEF2FF] text-[#3B5BCC]"
                : "border-l-2 border-[#FECDD0] bg-[#FEF1F2] text-[#A8323C]"
          }`}
        >
      ...
      <div className="mt-3 flex items-center justify-between gap-4">
        <div className="flex flex-wrap items-center gap-x-4 gap-y-1 text-xs text-slate-500">
          {field.evidence.length > 0 && (
            <span>
              来源：{field.evidence[0].chapter}，第 {field.evidence[0].page} 页
            </span>
          )}
          {field.evidence.length > 0 && (
            <span
              className={`${
                field.evidence[0].confidence >= 90
                  ? "text-[#116B46]"
                  : field.evidence[0].confidence >= 75
                    ? "text-[#8B520B]"
                    : "text-[#A8323C]"
              }`}
            >
          ...
          {field.confirmedBy && (
            <span className="flex items-center gap-1 text-[#116B46]">
              ...
              {field.confirmedBy} · {field.confirmedAt?.slice(11)}
            </span>
          )}
        </div>
        ...
        {!readOnly && (
          <div className="flex shrink-0 items-center gap-2">
            ...
            {isScope ? (
              ...
              <>
                <button
                  onClick={() => onResolveConflict(field)}
            ...
            {field.status !== "reference-only" && (
              <div className="relative" ref={moreRef}>
                <button
                  ...
                  className={`h-8 w-8 rounded-lg border border-slate-300 flex items-center justify-center text-slate-500 hover:border-[#2E5495] hover:text-[#24457C] ${
                    moreOpen ? "bg-slate-50" : ""
                  }`}
                >
                ...
                {moreOpen && (
                  <div className="absolute right-0 top-9 z-10 w-36 rounded-lg border border-slate-200 bg-white py-1 shadow-[0_4px_16px_rgba(15,23,42,.12)]">
                    {field.status !== "not-applicable" && (
                      <button
                        className="w-full px-3 py-2 text-left text-[13px] text-slate-600 hover:bg-slate-50"
                        onClick={() => {
                          onConfirm(field.id);
                          setMoreOpen(false);
                        }}
                    ...
                    {field.status === "confirmed" && (
                      <button
                        className="w-full px-3 py-2 text-left text-[13px] text-[#A8323C] hover:bg-slate-50"
                        onClick={() => {
                          onConfirm(field.id);
                          setMoreOpen(false);
                        }}
...
function FieldConfirmationFooter({
  p0Count,
  navigate,
  onSave,
  readOnly,
...
function sortFields(fields: Field[]): Field[] {
  const order: Record<string, number> = {
    ...
    "P2-pending": 12,
    "P2-confirmed": 13,
    "P1-reference-only": 14,
    "P2-reference-only": 15,
  };
...
export function FieldConfirmationPage({ navigate }: { navigate: (p: Page) => void }) {
      ...
      prev.map((f) =>
        f.id === id
          ? {
              ...
              status: "confirmed",
              confirmedBy: "王明远",
              confirmedAt: `2026-09-05 ${new Date().toTimeString().slice(0, 5)}`,
            }
          : f,
      ),
    );
  ...
  if (criticalityFilter !== "all")
    visible = visible.filter((f) => f.criticality === criticalityFilter);
  if (onlyBlocked)
